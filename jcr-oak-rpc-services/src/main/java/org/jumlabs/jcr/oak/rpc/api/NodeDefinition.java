...
public class NodeDefinition implements org.apache.thrift.TBase<NodeDefinition, NodeDefinition._Fields>, java.io.Serializable, Cloneable, Comparable<NodeDefinition> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("NodeDefinition");
  ...
  static {
    schemes.put(StandardScheme.class, new NodeDefinitionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new NodeDefinitionTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(NodeDefinition.class, metaDataMap);
  }
   ...
   */
  public NodeDefinition(NodeDefinition other) {
  ...
  public NodeDefinition deepCopy() {
  ...
  public NodeDefinition setDefaultPrimaryType(String defaultPrimaryType) {
    this.defaultPrimaryType = defaultPrimaryType;
    return this;
  }
  ...
  public NodeDefinition setRequiredPrimaryTypes(List<String> requiredPrimaryTypes) {
    this.requiredPrimaryTypes = requiredPrimaryTypes;
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof NodeDefinition)
      return this.equals((NodeDefinition)that);
    return false;
  }

  public boolean equals(NodeDefinition that) {
    if (that == null)
      return false;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("NodeDefinition(");
    boolean first = true;
  ...
  private static class NodeDefinitionStandardSchemeFactory implements SchemeFactory {
    public NodeDefinitionStandardScheme getScheme() {
      return new NodeDefinitionStandardScheme();
    }
  }

  private static class NodeDefinitionStandardScheme extends StandardScheme<NodeDefinition> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, NodeDefinition struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, NodeDefinition struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class NodeDefinitionTupleSchemeFactory implements SchemeFactory {
    public NodeDefinitionTupleScheme getScheme() {
      return new NodeDefinitionTupleScheme();
    }
  }

  private static class NodeDefinitionTupleScheme extends TupleScheme<NodeDefinition> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, NodeDefinition struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, NodeDefinition struct) throws org.apache.thrift.TException {
