...
public class PropertyDefinition implements org.apache.thrift.TBase<PropertyDefinition, PropertyDefinition._Fields>, java.io.Serializable, Cloneable, Comparable<PropertyDefinition> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PropertyDefinition");
  ...
  static {
    schemes.put(StandardScheme.class, new PropertyDefinitionStandardSchemeFactory());
    schemes.put(TupleScheme.class, new PropertyDefinitionTupleSchemeFactory());
  }

  public List<Value> defaultValues; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PropertyDefinition.class, metaDataMap);
  }
  ...
  public PropertyDefinition(PropertyDefinition other) {
    ...
    if (other.isSetDefaultValues()) {
      List<Value> __this__defaultValues = new ArrayList<Value>(other.defaultValues.size());
      for (Value other_element : other.defaultValues) {
        __this__defaultValues.add(new Value(other_element));
      }
  ...
  public java.util.Iterator<Value> getDefaultValuesIterator() {
    return (this.defaultValues == null) ? null : this.defaultValues.iterator();
  }

  public void addToDefaultValues(Value elem) {
    if (this.defaultValues == null) {
      this.defaultValues = new ArrayList<Value>();
    }
  ...
  public PropertyDefinition setDefaultValues(List<Value> defaultValues) {
    this.defaultValues = defaultValues;
    return this;
  }
  ...
  public PropertyDefinition setRequiredType(int requiredType) {
    this.requiredType = requiredType;
    setRequiredTypeIsSet(true);
    return this;
  }
  ...
  public PropertyDefinition setIsMultiple(boolean isMultiple) {
    this.isMultiple = isMultiple;
    setIsMultipleIsSet(true);
    return this;
  }
  ...
  public PropertyDefinition setIsQueryOrderable(boolean isQueryOrderable) {
    this.isQueryOrderable = isQueryOrderable;
    setIsQueryOrderableIsSet(true);
    return this;
  }
  ...
  public PropertyDefinition setIsFullTextSercheable(boolean isFullTextSercheable) {
    this.isFullTextSercheable = isFullTextSercheable;
    setIsFullTextSercheableIsSet(true);
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case DEFAULT_VALUES:
      if (value == null) {
        ...
        setDefaultValues((List<Value>)value);
      }
      break;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof PropertyDefinition)
      return this.equals((PropertyDefinition)that);
    return false;
  }

  public boolean equals(PropertyDefinition that) {
    if (that == null)
      return false;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("PropertyDefinition(");
    boolean first = true;
  ...
  private static class PropertyDefinitionStandardSchemeFactory implements SchemeFactory {
    public PropertyDefinitionStandardScheme getScheme() {
      return new PropertyDefinitionStandardScheme();
    }
  }

  private static class PropertyDefinitionStandardScheme extends StandardScheme<PropertyDefinition> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, PropertyDefinition struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.defaultValues = new ArrayList<Value>(_list0.size);
                Value _elem1;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PropertyDefinition struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.defaultValues != null) {
        oprot.writeFieldBegin(DEFAULT_VALUES_FIELD_DESC);
        {
          ...
          for (Value _iter3 : struct.defaultValues)
          {
            _iter3.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class PropertyDefinitionTupleSchemeFactory implements SchemeFactory {
    public PropertyDefinitionTupleScheme getScheme() {
      return new PropertyDefinitionTupleScheme();
    }
  }

  private static class PropertyDefinitionTupleScheme extends TupleScheme<PropertyDefinition> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PropertyDefinition struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetDefaultValues()) {
        {
          ...
          for (Value _iter4 : struct.defaultValues)
          {
            _iter4.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PropertyDefinition struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      BitSet incoming = iprot.readBitSet(6);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list5 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.defaultValues = new ArrayList<Value>(_list5.size);
          Value _elem6;
